...
CREATE TABLE Reservation (
    ...
    CONSTRAINT FK_Reservation_User FOREIGN KEY (userId) REFERENCES NormalUser(userId),
    CONSTRAINT FK_Reservation_Material FOREIGN KEY (materialId) REFERENCES Material(materialId)
);
GO
...
CREATE TABLE Loan (
    ...
    loanStatus NVARCHAR(20) CHECK (loanStatus IN ('Active', 'Overdue', 'Completed','Canceled')) NOT NULL DEFAULT 'Active',
    CONSTRAINT FK_Loan_Reservation FOREIGN KEY (reservationId) REFERENCES Reservation(reservationId),
    CONSTRAINT FK_Loan_NormalUser FOREIGN KEY (librarianId) REFERENCES NormalUser(userId)
);
GO
...
(2, 'El principito', 'Antoine de Saint-Exupéry', 1943, 'Education', 'Book', 'Reserved', 'New', 96, NULL, NULL),
(3, 'Inception', 'Christopher Nolan', 2010, 'Engineering', 'AudioVisual', 'Loaned', 'New', NULL, '148 min', 'Blu-ray'),
